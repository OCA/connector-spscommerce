...
class SaleOrder(models.Model):
    ...
    edi_error = fields.Text('EDI Errors',
                            help="Text that will describe failures to add sale order lines because of failing product lookups.")
    ...
    tracking_num = fields.Char('Tracking Number',
    ...
    def create_855(self, cr, uid, sale_ids, context=None):
        ...
        for sale_id in sale_ids:
            ...
            po_date = datetime.strptime(sale_obj.date_order,
                                        '%Y-%m-%d %H:%M:%S')
            ...
            xml_output += '<TsetPurposeCode>' + str(
                sale_obj.tset_purpose_code) + '</TsetPurposeCode>'
            xml_output += '<PurchaseOrderDate>' + po_date + '</PurchaseOrderDate>'
            xml_output += '<PurchaseOrderTypeCode>' + str(
                sale_obj.purchase_order_type_code) + '</PurchaseOrderTypeCode>'
            xml_output += '<POTypeDescription>' + str(
                sale_obj.po_type_description) + '</POTypeDescription>'
            ...
            xml_output += '<ShipCompleteCode>' + str(
                sale_obj.ship_complete_code) + '</ShipCompleteCode>'
            xml_output += '<BuyersCurrency>' + str(
                sale_obj.pricelist_id.currency_id.name) + '</BuyersCurrency>'
            xml_output += '<Department>' + str(
                sale_obj.department) + '</Department>'
            xml_output += '<Division>' + str(sale_obj.division) + '</Division>'
            xml_output += '<CustomerOrderNumber>' + str(
                sale_obj.name) + '</CustomerOrderNumber>'
            xml_output += '<PromotionDealNumber>' + str(
                sale_obj.promotion_deal_number) + '</PromotionDealNumber>'
            xml_output += '<Vendor>' + vendor_code + '</Vendor></OrderHeader>'
            xml_output += '<PaymentTerms><TermsType>' + str(
                sale_obj.terms_type) + '</TermsType>'
            xml_output += '<TermsBasisDateCode>' + str(
                sale_obj.terms_basis_date_code) + '</TermsBasisDateCode>'
            xml_output += '<TermsDiscountPercentage>' + str(
                sale_obj.terms_discount_percentage) + '</TermsDiscountPercentage>'
            xml_output += '<TermsDiscountDueDays>' + str(
                sale_obj.terms_discount_due_days) + '</TermsDiscountDueDays>'
            xml_output += '<TermsNetDueDays>' + str(
                sale_obj.terms_net_due_days) + '</TermsNetDueDays>'
            xml_output += '<TermsDescription>' + str(
                sale_obj.payment_term_id.note) + '</TermsDescription>'
            xml_output += '<PaymentMethodCode>' + str(
                sale_obj.payment_method_code) + '</PaymentMethodCode></PaymentTerms>'
            ...
            xml_output += '<ContactName>' + str(
                cust_rec.name) + '</ContactName>'
            xml_output += '<PrimaryPhone>' + str(
                cust_rec.phone) + '</PrimaryPhone>'
            xml_output += '<PrimaryFax>' + str(cust_rec.fax) + '</PrimaryFax>'
            xml_output += '<PrimaryEmail>' + str(
                cust_rec.email) + '</PrimaryEmail></Contact>'
            ...
            xml_output += '<AddressName>' + str(
                ship_address_rec.name) + '</AddressName>'
            xml_output += '<Address1>' + str(
                ship_address_rec.street) + '</Address1>'
            xml_output += '<Address2>' + str(
                ship_address_rec.street2) + '</Address2>'
            xml_output += '<City>' + str(ship_address_rec.city) + '</City>'
            xml_output += '<State>' + str(
                ship_address_rec.state_id.code) + '</State>'
            xml_output += '<PostalCode>' + str(
                ship_address_rec.zip) + '</PostalCode>'
            xml_output += '<Country>' + str(
                ship_address_rec.country_id.code) + '</Country>'
            xml_output += '<Contact><ContactTypeCode>CH</ContactTypeCode>'
            xml_output += '<ContactName>' + str(
                cust_rec.name) + '</ContactName>'
            xml_output += '<PrimaryPhone>' + str(
            ...
            xml_output += '<PrimaryFax>' + str(cust_rec.fax) + '</PrimaryFax>'
            xml_output += '<PrimaryEmail>' + str(
                cust_rec.email) + '</PrimaryEmail></Contact></Address>'

            # FOBRelatedInstruction
            xml_output += '<FOBRelatedInstruction><FOBPayCode>' + str(
                sale_obj.fob_pay_code) + '</FOBPayCode>'
            xml_output += '<FOBLocationQualifier>' + str(
                sale_obj.fob_location_qualifier) + '</FOBLocationQualifier>'
            xml_output += '<FOBLocationDescription>' + str(
                sale_obj.fob_location_description) + '</FOBLocationDescription>'
            xml_output += '<FOBTitlePassageCode>' + str(
                sale_obj.fob_title_passage_code) + '</FOBTitlePassageCode>'
            xml_output += '<FOBTitlePassageLocation>' + str(
                sale_obj.fob_title_passage_location) + '</FOBTitlePassageLocation></FOBRelatedInstruction>'

            # CarrierInformation
            xml_output += '<CarrierInformation><CarrierTransMethodCode>' + str(
                sale_obj.carrier_trans_method_code) + '</CarrierTransMethodCode>'
            xml_output += '<CarrierAlphaCode>' + str(
                sale_obj.carrier_alpha_code) + '</CarrierAlphaCode>'
            xml_output += '<CarrierRouting>' + str(
                sale_obj.carrier_routing) + '</CarrierRouting>'
            xml_output += '<RoutingSequenceCode>' + str(
                sale_obj.routing_sequence_code) + '</RoutingSequenceCode>'
            xml_output += '<ServiceLevelCodes><ServiceLevelCode>' + str(
                sale_obj.service_leve_code) + '</ServiceLevelCode></ServiceLevelCodes></CarrierInformation>'

            # Reference
            xml_output += '<Reference><ReferenceQual>' + str(
                sale_obj.reference_qual) + '</ReferenceQual>'
            xml_output += '<ReferenceID>' + str(
                sale_obj.reference_id) + '</ReferenceID>'
            xml_output += '<Description>' + str(
                sale_obj.ref_description) + '</Description></Reference>'

            # Notes
            xml_output += '<Notes><NoteCode>' + str(
                sale_obj.note_code) + '</NoteCode>'
            xml_output += '<NoteInformationField>' + str(
                sale_obj.note_information_field) + '</NoteInformationField></Notes>'

            # ChargesAllowances
            xml_output += '<ChargesAllowances><AllowChrgIndicator>' + str(
                sale_obj.allow_chrg_indicator) + '</AllowChrgIndicator>'
            xml_output += '<AllowChrgCode>' + str(
                sale_obj.allow_chrg_code) + '</AllowChrgCode>'
            xml_output += '<AllowChrgAgencyCode>' + str(
                sale_obj.allow_chrg_agency_code) + '</AllowChrgAgencyCode>'
            xml_output += '<AllowChrgAgency>' + str(
                sale_obj.allow_chrg_agency) + '</AllowChrgAgency>'
            xml_output += '<AllowChrgAmt>' + str(
                sale_obj.allow_chrg_amt) + '</AllowChrgAmt>'
            xml_output += '<AllowChrgPercentQual>' + str(
                sale_obj.allow_chrg_percent_qual) + '</AllowChrgPercentQual>'
            xml_output += '<AllowChrgPercent>' + str(
                sale_obj.allow_chrg_percent) + '</AllowChrgPercent>'
            xml_output += '<AllowChrgHandlingCode>' + str(
                sale_obj.allow_chrg_handling_code) + '</AllowChrgHandlingCode>'
            xml_output += '<ReferenceIdentification>' + str(
                sale_obj.reference_identification) + '</ReferenceIdentification>'
            xml_output += '<AllowChrgHandlingDescription>' + str(
                sale_obj.allow_chrg_handling_description) + '</AllowChrgHandlingDescription></ChargesAllowances></Header><LineItems>'
            ...
            for line in sale_lines:
                ...
                if line.edi_est_ship_date:
                    est_ship_date = datetime.strptime(line.edi_est_ship_date,
                                                      '%Y-%m-%d')
                ...
                xml_output += '<LineSequenceNumber>' + str(
                    line.id) + '</LineSequenceNumber>'
                xml_output += '<BuyerPartNumber>' + str(
                    line.buyer_part_number) + '</BuyerPartNumber>'
                xml_output += '<VendorPartNumber>' + str(
                    line.vendor_part_number) + '</VendorPartNumber>'
                xml_output += '<ConsumerPackageCode>' + str(
                    line.consumer_package_code) + '</ConsumerPackageCode>'
                xml_output += '<GTIN>' + str(line.gtin) + '</GTIN>'
                xml_output += '<UPCCaseCode>' + str(
                    line.upc_case_code) + '</UPCCaseCode>'
                xml_output += '<ProductID><PartNumberQual>MN</PartNumberQual>'
                xml_output += '<PartNumber>' + str(
                    line.product_id.default_code) + '</PartNumber></ProductID>'
                xml_output += '<OrderQty>' + str(uom) + '</OrderQty>'
                xml_output += '<OrderQtyUOM>' + str(
                    line.edi_line_qty) + '</OrderQtyUOM>'
                xml_output += '<PurchasePrice>' + str(
                    line.price_unit) + '</PurchasePrice>'
                xml_output += '<PurchasePriceBasis>' + str(
                    line.purchase_price_basis) + '</PurchasePriceBasis>'
                xml_output += '<BuyersCurrency>' + str(
                    sale_obj.pricelist_id.currency_id.name) + '</BuyersCurrency>'
                xml_output += '<ProductSizeCode>' + str(
                    line.product_size_code) + '</ProductSizeCode>'
                xml_output += '<ProductSizeDescription>' + str(
                    line.product_size_description) + '</ProductSizeDescription>'
                xml_output += '<ProductColorCode>' + str(
                    line.product_color_code) + '</ProductColorCode>'
                xml_output += '<ProductColorDescription>' + str(
                    line.product_color_description) + '</ProductColorDescription>'
                xml_output += '<ProductMaterialCode>' + str(
                    line.product_material_code) + '</ProductMaterialCode>'
                xml_output += '<ProductMaterialDescription>' + str(
                    line.product_material_description) + '</ProductMaterialDescription>'
                xml_output += '<Department>' + str(
                    line.department) + '</Department>'
                xml_output += '<Class>' + str(
                    line.classs) + '</Class></OrderLine>'

                # date
                xml_output += '<Date><DateTimeQualifier1>' + str(
                    line.price_unit) + '</DateTimeQualifier1>'
                xml_output += '<Date1>' + today + '</Date1></Date>'

                # PriceInformation
                xml_output += '<PriceInformation><PriceTypeIDCode>' + str(
                    line.price_unit) + '</PriceTypeIDCode>'
                xml_output += '<UnitPrice>' + str(
                    line.price_unit) + '</UnitPrice>'
                xml_output += '<Quantity>' + str(quantity) + '</Quantity>'
                xml_output += '<MultiplePriceQuantity>' + str(
                    line.multiple_price_quantity) + '</MultiplePriceQuantity>'
                xml_output += '<ClassOfTradeCode>' + str(
                    line.class_of_trade_code) + '</ClassOfTradeCode></PriceInformation>'

                # ProductOrItemDescription
                xml_output += '<ProductOrItemDescription><ItemDescriptionType>' + str(
                    line.item_description_type) + '</ItemDescriptionType>'
                xml_output += '<ProductCharacteristicCode>' + str(
                    line.product_characteristic_code) + '</ProductCharacteristicCode>'
                xml_output += '<AgencyQualifierCode>' + str(
                    line.agency_qualifier_code) + '</AgencyQualifierCode>'
                xml_output += '<ProductDescriptionCode>' + str(
                    line.product_description_code) + '</ProductDescriptionCode>'
                xml_output += '<ProductDescription>' + str(
                    line.name) + '</ProductDescription></ProductOrItemDescription>'

                # PhysicalDetails
                xml_output += '<PhysicalDetails><PackQualifier>' + str(
                    line.pack_qualifier) + '</PackQualifier>'
                xml_output += '<PackValue>' + str(
                    line.pack_value) + '</PackValue>'
                xml_output += '<PackSize>' + str(
                    line.pack_size) + '</PackSize>'
                xml_output += '<PackUOM>' + str(line.pack_uom) + '</PackUOM>'
                xml_output += '<PackingMedium>' + str(
                    line.packing_medium) + '</PackingMedium>'
                xml_output += '<PackingMaterial>' + str(
                    line.packing_material) + '</PackingMaterial>'
                xml_output += '<PackWeight>' + str(
                    line.pack_weight) + '</PackWeight>'
                xml_output += '<PackWeightUOM>' + str(
                    line.pack_weight_uom) + '</ProductDescription></PackWeightUOM>'
                ...
                xml_output += '<PostalCode>' + str(
                    ship_address_rec.zip) + '</PostalCode>'
                xml_output += '<Country>' + str(
                    ship_address_rec.country_id.code) + '</Country></Address>'

                # ChargesAllowances
                xml_output += '<ChargesAllowances><AllowChrgIndicator>' + str(
                    line.allow_chrg_indicator) + '</AllowChrgIndicator>'
                xml_output += '<AllowChrgCode>' + str(
                    line.allow_chrg_code) + '</AllowChrgCode>'
                xml_output += '<AllowChrgAgencyCode>' + str(
                    line.allow_chrg_agency_code) + '</AllowChrgAgencyCode>'
                xml_output += '<AllowChrgAgency>' + str(
                    line.allow_chrg_agency) + '</AllowChrgAgency>'
                xml_output += '<AllowChrgAmt>' + str(
                    line.allow_chrg_amt) + '</AllowChrgAmt>'
                xml_output += '<AllowChrgPercent>' + str(
                    line.allow_chrg_percent) + '</AllowChrgPercent>'
                xml_output += '<PercentDollarBasis>' + str(
                    line.percent_dollar_basis) + '</PercentDollarBasis>'
                xml_output += '<AllowChrgRate>' + str(
                    line.allow_chrg_rate) + '</AllowChrgRate>'
                xml_output += '<AllowChrgQtyUOM>' + str(
                    line.allow_chrg_qty_uom) + '</AllowChrgQtyUOM>'
                xml_output += '<AllowChrgHandlingCode>' + str(
                    line.allow_chrg_handling_code) + '</AllowChrgHandlingCode>'
                xml_output += '<AllowChrgHandlingDescription>' + str(
                    line.allow_chrg_handling_description) + '</AllowChrgHandlingDescription></ChargesAllowances>'

                # line item acknowledgement                
                xml_output += '<LineItemAcknowledgement>'
                xml_output += '<ItemStatusCode>' + str(
                    line.edi_line_msg) + '</ItemStatusCode>'
                xml_output += '<ItemScheduleQty>' + str(
                    quantity) + '</ItemScheduleQty>'
                xml_output += '<ItemScheduleUOM>' + str(
                    uom) + '</ItemScheduleUOM>'
                xml_output += '<ItemScheduleQualifier>002</ItemScheduleQualifier>'
                xml_output += '<ItemScheduleDate>' + str(
                    line.edi_est_ship_date) + '</ItemScheduleDate></LineItemAcknowledgement>'

                xml_output += '<PriceInformation><PriceTypeIDCode>FCP</PriceTypeIDCode>'
                xml_output += '<UnitPrice>' + str(
                    line.price_unit) + '</UnitPrice></PriceInformation>'

                for tax in line.tax_id:
                    xml_output += '<Tax><TaxTypeCode>H780</TaxTypeCode>'
                    xml_output += '<TaxAmount>' + str(
                        1 + tax.amount / 100 * line.price_unit) + '</TaxAmount>'
                    xml_output += '<TaxPercent>' + str(
                        tax.amount / 100) + '</TaxPercent><TaxExemptCode>0</TaxExemptCode><TaxID>99990000</TaxID></Tax>'
            ...
            # Summary
            xml_output += '<Summary><TotalAmount>' + str(
                sale_obj.amount_total) + '</TotalAmount>'
            xml_output += '<TotalLineItemNumber>' + str(
                total_lines) + '</TotalLineItemNumber>'
            xml_output += '<TotalQuantity>' + str(
                total_qty) + '</TotalQuantity>'
            xml_output += '<TotalWeight>' + str(
    ...
    def _prepare_order_line_procurement(self, group_id=False):
        ...
        for sale_line in self.order_line:
            ...
            res[
                'trading_partner_id'] = self.trading_partner_id and self.trading_partner_id.id or False
            res['edi_yes'] = self.trading_partner_id and self.edi_yes or False
            res[
                'ship_not_before_date'] = self.trading_partner_id and self.ship_not_before_date or False
            res[
                'cancel_after_date'] = self.trading_partner_id and self.cancel_after_date or False
    ...
    def _prepare_invoice(self):
        ...
        res[
            'bol_num'] = self.picking_ids and pick and pick.bol_num or self.bol_num or ''
        res['picking_ids'] = self.picking_ids
        res[
            'scac_code'] = self.picking_ids and pick and pick.carrier_id.scac_code or self.scac_code or False
        res[
            'tracking_num'] = self.picking_ids and pick and pick.tracking_number or ''
        ...
        res[
            'fob_title_passage_location'] = self.fob_title_passage_location or ''
        ...
        res[
            'allow_chrg_handling_description'] = self.allow_chrg_handling_description or ''
        return res
...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, qty):
        ...
        res[
            'product_material_description'] = self.product_material_description or ''
        res['department'] = self.department or ''
        ...
        res[
            'product_characteristic_code'] = self.product_characteristic_code or ''
    ...
    def edi_line_status_change(self, cr, uid, ids, order_id, edi_line_msg,
                               order_edi_last_date, context=None):
        res = {'value': {'state': 'draft',
    ...
    ack_yes = fields.Boolean('855', readonly=True,
                             help="Will this order have an 855?")
    edi_est_del_date = fields.Date('Est. Del. Date',
                                   help="Line Item Estimated Delivery Date")
    edi_est_ship_date = fields.Date('Est. Ship Date',
                                    help="Line Item Estimated Shipping Date")
    edi_line_msg = fields.Selection((('reject', 'Reject'),
                                     ('accept', 'Accept'),
                                     ('backorder', 'Backorder')),
                                    'EDI Line Status')
    ...
    trading_partner_id = fields.Many2one('edi.config', 'Trading Partner',
                                         help='EDI Configuration information for partner')
    edi_intransit_qty = fields.Float('Incoming Qty',
                                     digits_compute=dp.get_precision(
                                         'Product Unit of Measure'))
    edi_outgoing_qty = fields.Float('Reserved Qty',
                                    digits_compute=dp.get_precision(
                                        'Product Unit of Measure'))
    edi_avlforsale_qty = fields.Float('Available for Sale',
                                      digits_compute=dp.get_precision(
                                          'Product Unit of Measure'))
